...
function buildToDos(toDos) {
  // Tu código acá:
  const creador = toDos.map(buildToDo);
  return creador;
}
...
function addToDo() {
  ...
  const NuevoTodo = new ToDo(toDoInput);
...
// Tu código acá:
const clickButtom = document.querySelector("#addButton");

clickButtom.addEventListener("click", addToDo);
